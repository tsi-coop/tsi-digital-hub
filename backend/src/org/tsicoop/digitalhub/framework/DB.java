...
public abstract class DB {
    ...
    public int fetchCount(DBQuery query) throws Exception{
    ...
    public DBResult fetch(DBQuery query) throws Exception{
        PreparedStatement pstmt = null;
        StringBuffer buff = null;
        ResultSet rs = null;
        int count = 0;
    ...
    public void update(DBQuery query) throws Exception{
        PreparedStatement pstmt = null;
        StringBuffer buff = null;
        Iterator<JSONObject> valueIt = null;
        JSONObject value = null;
    ...
    public void update(List<DBQuery> queries) throws Exception{
        PreparedStatement pstmt = null;
        StringBuffer buff = null;
        Iterator<JSONObject> valueIt = null;
        JSONObject value = null;
    ...
    public int insert(DBQuery insert) throws Exception{
        PreparedStatement pstmt = null;
        StringBuffer buff = null;
        Iterator<JSONObject> valueIt = null;
        JSONObject value = null;
