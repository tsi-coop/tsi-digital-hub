...
const SetupProfileStep4 = ({
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: "flex-start", alignItems: "flex-start", gap: '0px', width: "100%", }}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: "flex-start", alignItems: "flex-start", gap: '5px', width: "100%",paddingBottom:'30px' }}>
                <p style={{
                    fontFamily: "OpenSans",
                    fontSize: "40px",
                    fontWeight: 600,
                    ...
                    margin: 0,
                    padding: 0,
                }} >Suitable Skills needed for your Business</p>
                <p style={{
                    fontFamily: "OpenSans",
                    fontSize: "16px",
                    fontWeight: 400,
            ...
            <div style={{ display: 'flex', flexDirection: deviceType == "mobile" ? "column" : 'row', justifyContent: "space-evenly", alignItems: "flex-start", gap: '20px', width: "100%", height: '60%', marginTop: '20px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", width: "50%", }}>
                    <ListItem sx={{
                        ...
                        {(skillsInterested?.length > 0) && (<Checkbox
                            checked={skillsInterested?.length > 0 ? true : false}
                            onChange={() => { }}
                    ...
                    <Collapse in={openSkills} sx={{
                        width: '100%',
                        border: `1px solid ${colors.snowywhite}`,
                        borderBottomLeftRadius: openSkills ? "5px" : "5px",
                        borderBottomRightRadius: openSkills ? "5px" : "5px",
                    }} timeout="auto" unmountOnExit>
                        <CollapsibleTree data={skillsData} selectedItems={skillsInterested} setSelectedItems={setSkillsInterested} />
                    </Collapse>
                </div>
