...
import SetupAmbStep1 from '../AmbassadorSetup/SetupAmbStep1';
import SetupAmbStep2 from '../AmbassadorSetup/SetupAmbStep2';
import SetupAmbStep3 from '../AmbassadorSetup/SetupAmbStep3';
import SetupAmbStep4 from '../AmbassadorSetup/SetupAmbStep4';
import SetupAmbStep5 from '../AmbassadorSetup/SetupAmbStep5';
            ...
            .then((response: any) => {
                if (response.data._created) {
                    ...
                    setSnackbar({
                        open: true,
                        severity: 'success',
                        message: "Onboarding Ambassador successfull",
                    })
                } else {
                    setLoad(false)
                    setSnackbar({
    ...
    if (!load) {
        return (
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: "flex-start", alignItems: "flex-start", gap: '20px', width: deviceType === "mobile" ? "85%" : (deviceType === "tablet" || deviceType === "small-tablet") ? "75%" : "60%", height: '100%', }}>
